...
Этот аудит помогает найти логические ошибки, которые пропускают обычные линтеры и проверки битых ссылок.
...
1.  **Скан маршрутов:**
    Составь карту основных страниц:
    *   `/` -> Главная (Хаб)
    *   `/events` -> Услуги (Продажа)
    *   `/portfolio` -> Доказательства (Фото)
    *   `/contact` -> Связь (Действие)
...
> "Если я нажму эту кнопку с закрытыми глазами, ориентируясь только на текст, попаду ли я туда, где смогу сделать то, что написано?"
